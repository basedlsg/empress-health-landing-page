        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
             ...
             <div className="flex items-center space-x-2">
               ...
               <span className="text-2xl font-bold text-black">Empress Health</span>
             </div>
            ...
            <div className="flex space-x-4">
                             <Button variant="outline" className="bg-yellow-100 text-black border-yellow-200 hover:bg-yellow-200">
                 Sign in
               </Button>
               <Button onClick={handleGetStarted} className="bg-black hover:bg-gray-800">
                Get started
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                                 <Button onClick={handleGetStarted} size="lg" className="bg-black hover:bg-gray-800">
                   Get started
                 </Button>
                 <Button size="lg" variant="outline" className="bg-yellow-100 text-black border-yellow-200 hover:bg-yellow-200">
                  Sign in
                </Button>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-100 to-yellow-100 rounded-2xl p-8 text-center">
              <div className="w-full h-80 bg-gradient-to-br from-purple-200 to-yellow-200 rounded-xl flex items-center justify-center">
                <div className="text-center">
                                     <div className="text-2xl font-bold text-black mb-2">Where Menopause Meets Care That Listens</div>
                   <div className="text-gray-600">Empress Health. Smarter care for menopause, built on empathy and designed for you</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm text-gray-500 mb-2">Backed by experts</p>
                         <h2 className="text-4xl font-bold text-black">Smart care, compassionate support.</h2>
          </div>
                ...
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Star className="h-6 w-6 text-purple-700" />
                                     ...
                                     <h3 className="font-bold text-black mb-2">Trusted guidance</h3>
                ...
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <TrendingUp className="h-6 w-6 text-purple-700" />
                                     ...
                                     <h3 className="font-bold text-black mb-2">Smarter support</h3>
                ...
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Star className="h-6 w-6 text-purple-700" />
                                     ...
                                     <h3 className="font-bold text-black mb-2">Tailored to you</h3>
                ...
                <CardContent className="p-6 text-center">
                  <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <TrendingUp className="h-6 w-6 text-purple-700" />
                                     ...
                                     <h3 className="font-bold text-black mb-2">Confidence boost</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
               ...
               <span className="text-black text-sm">Global support for women</span>
             </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                                 <li><a href="#" className="hover:text-black">Onboarding Process</a></li>
                 <li><a href="#" className="hover:text-black">Wellness Features</a></li>
                 <li><a href="#" className="hover:text-black">Resources & Blog</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                 ...
                 <li><a href="#" className="hover:text-black">Newsletter</a></li>
          ...
          <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
               ...
               <Crown className="h-8 w-8 text-black" />
               <span className="text-xl font-bold text-black">Empress Health</span>
             </div>
            <div className="flex space-x-6 text-sm text-gray-600">
                             <a href="#" className="hover:text-black">Accept the legal terms</a>
