...
const NAV_LOGO = {
  url: "https://empresshealth.com",
  src: "/empress-health-logo.png",
  alt: "Empress Health logo",
  title: "Empress Health",
};
const NAV_ITEMS = [
  { name: "Home", link: "/" },
  { name: "Shop", link: "/shop" },
    ...
    <section className="py-4 bg-background">
      <nav className="container mx-auto flex items-center justify-between">
        ...
        <a href={NAV_LOGO.url} className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold tracking-tighter text-primary font-[var(--font-display)]">
            {NAV_LOGO.title}
          </span>
        </a>
                ...
                <NavigationMenuItem>
                  <Link href={item.link} passHref>
                    <NavigationMenuLink
                      ...
                      className={`relative cursor-pointer text-sm font-medium hover:bg-transparent font-[var(--font-body)] ${
        ...
        <div className="hidden items-center gap-2 lg:flex">
          <Button
            variant="outline"
            size="sm"
            className="h-10 py-2.5 text-sm font-normal font-[var(--font-body)] border-primary text-primary hover:bg-primary hover:text-primary-foreground"
          >
            Sign In
          </Button>
        </div>
        ...
        >
          <ul className="bg-background text-foreground w-full py-4">
            {NAV_ITEMS.map((navItem, idx) => (
              <li key={idx}>
                <Link
                  ...
                  className={`text-foreground flex items-center border-l-[3px] px-6 py-4 text-sm font-medium transition-all duration-75 font-[var(--font-body)] ${
            ...
            <li className="flex flex-col px-7 py-2">
              <Button variant="secondary" className="font-[var(--font-body)]">Sign In</Button>
            </li>
          </ul>
        </PopoverContent>
      </Popover>
