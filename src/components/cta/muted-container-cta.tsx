  ...
  return (
    <section className="py-32 bg-background">
      <div className="container mx-auto">
        <div className="relative mx-auto flex max-w-4xl flex-col justify-center overflow-hidden rounded-xl border bg-secondary/30 p-6 md:p-12">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-semibold md:text-4xl font-[var(--font-display)] text-foreground">
              Join the Waitlist
            </h2>
            <p className="mt-4 text-muted-foreground md:text-lg font-[var(--font-body)]">
